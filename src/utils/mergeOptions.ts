...
function getInputOptions(
	...
	const inputOptions: InputOptions = {
		...
		aggressivelyMergeModules: getOption('aggressivelyMergeModules'),
		hashedChunkNames: getOption('hashedChunkNames'),
		minifyInternalNames: getOption('minifyInternalNames'),
